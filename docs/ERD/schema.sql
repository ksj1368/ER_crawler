...
CREATE TABLE match_info (
    ...
    FOREIGN KEY (main_weather) REFERENCES weather_info (weather_id),
    FOREIGN KEY (sub_weather) REFERENCES weather_info (weather_id)
);
...
CREATE TABLE match_user_start (
    ...
    FOREIGN KEY (character_num) REFERENCES character_info (character_id),
...
CREATE TABLE match_user_trait (
    ...
    FOREIGN KEY (match_id, user_num) REFERENCES match_user_start (match_id, user_num),
    FOREIGN KEY (trait_id) REFERENCES trait_info (trait_id)
);
...
CREATE TABLE match_user_equipment (
    ...
    PRIMARY KEY (match_id, user_num),
    FOREIGN KEY (match_id, user_num) REFERENCES match_user_start (match_id, user_num),
    FOREIGN KEY (first_weapon) REFERENCES item_weapon (item_id),
    FOREIGN KEY (last_weapon) REFERENCES item_weapon (item_id),
    FOREIGN KEY (best_weapon) REFERENCES item_weapon (item_id),
    FOREIGN KEY (first_chest) REFERENCES item_armor (item_id),
    FOREIGN KEY (first_head) REFERENCES item_armor (item_id),
    FOREIGN KEY (first_arm) REFERENCES item_armor (item_id),
    FOREIGN KEY (first_leg) REFERENCES item_armor (item_id),
    FOREIGN KEY (last_chest) REFERENCES item_armor (item_id),
    FOREIGN KEY (last_head) REFERENCES item_armor (item_id),
    FOREIGN KEY (last_arm) REFERENCES item_armor (item_id),
    FOREIGN KEY (last_leg) REFERENCES item_armor (item_id)
);
...
CREATE TABLE match_user_gadget (
    ...
    PRIMARY KEY (match_id, user_num, gadget_id),
    FOREIGN KEY (match_id, user_num) REFERENCES match_user_start (match_id, user_num),
    FOREIGN KEY (gadget_id) REFERENCES installation_info (installation_id)
);