"""initial_schema_docker

Revision ID: 38cbb6ad2222
Revises: 
Create Date: 2026-01-11 01:10:32.491772
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('area_id', 'season', 'major_version', 'minor_version', name=op.f('pk_area_info'))
    )
    ...
    sa.PrimaryKeyConstraint('armor_id', name=op.f('pk_armor_types')),
    sa.UniqueConstraint('armor_name', name=op.f('uq_armor_types_armor_name'))
    )
    ...
    sa.PrimaryKeyConstraint('character_id', 'season', 'major_version', 'minor_version', name=op.f('pk_character_info'))
    )
    ...
    sa.PrimaryKeyConstraint('character_id', 'season', 'major_version', 'minor_version', name=op.f('pk_character_levelup_stats'))
    )
    ...
    sa.PrimaryKeyConstraint('source_id', name=op.f('pk_credit_acquisition_source')),
    sa.UniqueConstraint('source_name', name=op.f('uq_credit_acquisition_source_source_name'))
    )
    op.create_table('credit_expenditure_source',
    sa.Column('source_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('source_name', sa.String(length=64), nullable=True),
    sa.PrimaryKeyConstraint('source_id', name=op.f('pk_credit_expenditure_source')),
    sa.UniqueConstraint('source_name', name=op.f('uq_credit_expenditure_source_source_name'))
    )
    ...
    sa.PrimaryKeyConstraint('installation_id', 'season', 'major_version', 'minor_version', name=op.f('pk_installation_info'))
    )
    ...
    sa.PrimaryKeyConstraint('item_id', 'season', 'major_version', 'minor_version', name=op.f('pk_item_armor'))
    )
    ...
    sa.PrimaryKeyConstraint('item_id', 'season', 'major_version', 'minor_version', name=op.f('pk_item_weapon'))
    )
    ...
    sa.PrimaryKeyConstraint('match_id', name=op.f('pk_match_info'))
    )
    ...
    sa.PrimaryKeyConstraint('monster_id', 'season', 'major_version', 'minor_version', name=op.f('pk_monster_info'))
    )
    ...
    sa.PrimaryKeyConstraint('tactical_skill_id', name=op.f('pk_tactical_skills')),
    sa.UniqueConstraint('tactical_skill_name', name=op.f('uq_tactical_skills_tactical_skill_name'))
    )
    ...
    sa.PrimaryKeyConstraint('trait_id', 'season', 'major_version', 'minor_version', name=op.f('pk_trait_info'))
    )
    ...
    sa.PrimaryKeyConstraint('user_num', name=op.f('pk_user')),
    ...
    sa.PrimaryKeyConstraint('weapon_id', name=op.f('pk_weapon_types')),
    sa.UniqueConstraint('weapon_name', name=op.f('uq_weapon_types_weapon_name'))
    )
    ...
    sa.PrimaryKeyConstraint('weather_id', 'season', 'major_version', 'minor_version', name=op.f('pk_weather_info'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id'], ['match_info.match_id'], name=op.f('fk_match_team_info_match_id_match_info')),
    sa.PrimaryKeyConstraint('match_id', 'team_number', name=op.f('pk_match_team_info'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'team_number'], ['match_team_info.match_id', 'match_team_info.team_number'], name=op.f('fk_match_user_start_match_id_match_team_info')),
    sa.ForeignKeyConstraint(['match_id'], ['match_info.match_id'], name=op.f('fk_match_user_start_match_id_match_info')),
    sa.ForeignKeyConstraint(['user_num'], ['user.user_num'], name=op.f('fk_match_user_start_user_num_user')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', name=op.f('pk_match_user_start'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_combat_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', name=op.f('pk_match_user_combat'))
    )
    ...
    sa.ForeignKeyConstraint(['acquisition_source_id'], ['credit_acquisition_source.source_id'], name=op.f('fk_match_user_credit_acquisitions_acquisition_source_id_credit_acquisition_source')),
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_credit_acquisitions_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', 'acquisition_source_id', name=op.f('pk_match_user_credit_acquisitions'))
    )
    op.create_table('match_user_credit_expenditures',
    sa.Column('match_id', sa.Integer(), nullable=False),
    sa.Column('user_num', sa.Integer(), nullable=False),
    sa.Column('event_seq', sa.Integer(), nullable=False, comment='Global purchase sequence for user'),
    sa.Column('expenditure_source_id', sa.Integer(), nullable=True),
    sa.Column('expenditure_type', sa.String(length=32), nullable=True),
    sa.Column('item_code', sa.Integer(), nullable=True, comment='Raw item code if applicable'),
    sa.Column('credit_amount', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['expenditure_source_id'], ['credit_expenditure_source.source_id'], name=op.f('fk_match_user_credit_expenditures_expenditure_source_id_credit_expenditure_source')),
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_credit_expenditures_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', 'event_seq', name=op.f('pk_match_user_credit_expenditures'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_credit_time_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', 'minute', name=op.f('pk_match_user_credit_time'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_damage_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', name=op.f('pk_match_user_damage'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_end_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', name=op.f('pk_match_user_end'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_equipment_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', name=op.f('pk_match_user_equipment'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_mmr_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', name=op.f('pk_match_user_mmr'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_object_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', 'metric_type', 'metric_name', name=op.f('pk_match_user_object'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_sight_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', name=op.f('pk_match_user_sight'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_stats_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', name=op.f('pk_match_user_stats'))
    )
    ...
    sa.ForeignKeyConstraint(['match_id', 'user_num'], ['match_user_start.match_id', 'match_user_start.user_num'], name=op.f('fk_match_user_trait_match_id_match_user_start')),
    sa.PrimaryKeyConstraint('match_id', 'user_num', 'trait_id', 'trait_type', name=op.f('pk_match_user_trait'))
    )
